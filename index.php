<?php
    ...
    $query = 'CREATE TABLE IF NOT EXISTS crud.pessoa (id INT NOT NULL AUTO_INCREMENT , nome TEXT NOT NULL , data_nascimento TEXT NOT NULL , genero TEXT NOT NULL , email TEXT NOT NULL , PRIMARY KEY (id))';
...
<body>
    <?php
        ...
        if($busca){
            ...
            if($result == null){
                echo '<h1 id="resultado" style="position:absolute;top: 90px;left:30px;">Nenhum resultado encontrado</h1>';
            }else{
                echo '<h1 id="resultado" style="position:absolute;top: 90px;left:30px;">Resultado da pesquisa</h1>';
            }
        }
    ?>
    <div class="container">
